...
@section('content')
    ...
    <div class="container mt-5">
        ...
        <div class="row page-titles justify-content-between py-3">
            <div class="col-md-5 align-self-center">
                <h3 class="text-themecolor">{{ $product->name }}</h3>
                <ol class="breadcrumb">
            ...
            <div class="col-md-2 mt-2">
                <button type="button" class="btn waves-effect waves-light btn btn-info pull-right text-white"
                    data-toggle="modal" data-target="#historyCreate">Update Stock</button>
        ...
        <div class="row">
            ...
            <div class="col-lg-12 d-flex align-items-stretch">
                <div class="card w-100 border border-dark shadow">
                    <div class="card-body">
                        <div class="d-flex">
                            <div>
                            ...
                            <div class="ms-auto w-50 d-flex justify-content-between">
                                <a class="text-primary" href="">Stock In
                                    ({{ $products->where('status', 1)->count() }})</a>
                                <a class="text-warning" href="">Stock Out
                                    ({{ $products->where('status', 2)->count() }})</a>
                                <a class="text-danger" href="">Damage
                                    ({{ $products->where('status', 3)->count() }})</a>
                                <a class="text-secondary" href="">Removed
                                    ({{ $products->where('status', 4)->count() }})</a>
                                        ...
                                        @foreach ($products as $item)
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    @else
                                                        <h4 class="text-secondary">Remove</h4>
                                                    @endif
                                                </td>
    ...
    <div class="modal fade bd-example-modal-lg" id="historyCreate" tabindex="-1" role="dialog"
        aria-labelledby="historyCreate" aria-hidden="true">
